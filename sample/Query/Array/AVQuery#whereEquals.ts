...
describe('Object', function () {
    ...
    before(function () {
        ...
        */
        ...
        let reminders = [new Date('2015-11-11 08:30:00'), new Date('2015-11-11 09:30:00')];
    ...
    // 实例方法使用 # 分隔类和方法
    it('AVQuery#whereContainsAll', function (done) {
        try {
            // 示例代码-Start
            let query = new AV.Query('Todo');
            let reminderFilter = [new Date('2015-11-11 08:30:00')];
